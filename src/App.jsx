...
const App = () => {
  ...
  const projectImages = {
    hero: {
      titleImage: ""  // Main title image replacing the bio text (Aspect ratio 3:2)
    },
    malaBySom: {
      background: "", // Background for the left side of the Music section
      cover: ""       // Album cover image inside the tile
    },
    rapiky: {
      background: "", // Background for the Rapíky section
      cover: ""       // Book cover image inside the tile
    },
    lsdolina: {
      background: "/terez-frecerova/public/lsdolina.jpeg"  // Background image for the podcast section
    },
    smiesna: {
