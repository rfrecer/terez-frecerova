...
const App = () => {
  ...
  const rawConcerts = [
    ...
    { venue: "[TBA]", city: "Bratislava, SK", date: "2026-05-23", link: "", imgColor: "bg-fuchsia-200", photoUrl: "" },
    { venue: "10 rokov Kurníka", city: "Bratislava, SK", date: "2026-05-21", link: "https://naskurnik.sk/", imgColor: "bg-orange-200", photoUrl: "" },
